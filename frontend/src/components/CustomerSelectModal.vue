...
defineProps<{
  ...
  items: CustomerItem[]  //-- 選択肢として表示する顧客一覧（親が company_id で API 取得して渡す）
...
const emit = defineEmits<{
  ...
  select: [customer: CustomerItem]  //-- ユーザーが行をクリックした際に、選択した CustomerItem を発火
  clear: []  //-- 「クリア」ボタン押下時に発火。選択解除を親に通知
}>()
      ...
      <div class="modal-dialog">
        <div class="modal-content select-modal customer-select-modal">
          ...
          <div class="modal-body modal-body--scroll">
            ...
            <table v-else class="data-table select-modal-table customer-select-modal-table">
              <thead>
