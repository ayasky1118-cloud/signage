...
<template>
  ...
  <main id="order-main-page">
          ...
          <section class="order-main-form-section">
            <div class="order-main-form-row order-main-form-row--block1">
              <div class="order-main-form-field order-main-form-field--order-no">
                <label class="form-label form-label--with-badge" :for="FORM_IDS.order.orderNo">
                  <span class="form-required-badge">必須</span>
                  注文番号
                </label>
                <div class="order-main-field-row">
                  <input
                    :id="FORM_IDS.order.orderNo"
                    ref="orderNoInputRef"
                    v-model="orderNo"
                    type="text"
              ...
              <div class="order-main-form-field order-main-form-field--w8">
                <label class="form-label form-label--with-badge" :for="FORM_IDS.order.status">ステータス</label>
                <select
                  :id="FORM_IDS.order.status"
                  v-model="status"
                  class="form-select"
                  :class="{ 'form-select--placeholder': !status }"
                  :disabled="otherFieldsDisabled"
                >
            ...
            <div class="order-main-form-row">
              <div class="order-main-form-field order-main-form-field--w24">
                ...
                <select
                  :id="FORM_IDS.order.productionType"
                  v-model="productionType"
                  class="form-select"
                  :class="{ 'form-select--placeholder': !productionType }"
                  :disabled="otherFieldsDisabled"
                >
              ...
              <div class="order-main-form-field order-main-form-field--w24">
                <label class="form-label form-label--with-badge" :for="FORM_IDS.order.deadline">納期</label>
                <input
                  :id="FORM_IDS.order.deadline"
              ...
              <div class="order-main-form-field order-main-form-field--w24">
                <label class="form-label form-label--with-badge" :for="FORM_IDS.order.proofreading">校正予定日</label>
                <input
                  :id="FORM_IDS.order.proofreading"
            ...
            <div class="order-main-form-field order-main-form-field--flex1">
              <label class="form-label form-label--with-badge" :for="FORM_IDS.order.address">
                <span class="form-required-badge">必須</span>
                住所
              </label>
              <input
                :id="FORM_IDS.order.address"
                ref="addressInputRef"
                v-model="address"
                type="text"
                class="form-input"
          ...
          <div class="order-main-form-block">
            <div class="order-main-form-block-row">
              <div class="order-main-form-field order-main-form-field--flex2">
                <label class="form-label form-label--with-badge" :for="FORM_IDS.order.customer">
                  <span class="form-required-badge">必須</span>
                  顧客
                </label>
                <div class="order-main-field-row">
                  <input
                    :id="FORM_IDS.order.customer"
              ...
              <div class="order-main-form-field order-main-form-field--flex1">
                <label class="form-label form-label--with-badge" :for="FORM_IDS.order.manager">担当者名</label>
                <input
                  :id="FORM_IDS.order.manager"
                  v-model="manager"
                  type="text"
                  class="form-input"
            ...
            <div class="order-main-form-block-row">
              <div class="order-main-form-field order-main-form-field--design-type">
                <label class="form-label form-label--with-badge" :for="FORM_IDS.order.designType">
                  <span class="form-required-badge">必須</span>
                  デザイン種別
                </label>
                <select
                  :id="FORM_IDS.order.designType"
              ...
              <div class="order-main-form-field order-main-form-field--flex2">
                <label class="form-label form-label--with-badge" :for="FORM_IDS.order.template">
                  <span class="form-required-badge">必須</span>
                  テンプレート
                </label>
                <div class="order-main-field-row">
                  <select
                    :id="FORM_IDS.order.template"
          ...
          <div class="order-main-form-grid order-main-form-grid--template">
            ...
            <div class="order-main-form-block">
              ...
              <template v-else>
                ...
                >
                  <label class="form-label form-label--with-badge" :for="FORM_IDS.order.templateItem(idx)">
                    <span v-if="item.isRequired" class="form-required-badge">必須</span>
                    {{ item.itemName }}
                  </label>
                  <input
                    :id="FORM_IDS.order.templateItem(idx)"
    ...
    <Teleport to="body">
      <div
        v-show="requiredValidationOpen"
        class="form-dialog"
        role="dialog"
        aria-modal="true"
        aria-labelledby="requiredValidationModalMessage"
        aria-hidden="false"
      >
        ...
        <div class="form-dialog-content form-dialog-content--narrow">
          <div class="form-dialog-body" style="text-align: center">
            <p id="requiredValidationModalMessage">{{ requiredValidationMessage }}</p>
          </div>
    ...
    <Teleport to="body">
      ...
      >
        ...
        <div class="form-dialog-content form-dialog-content--narrow">
          <div class="form-dialog-header">
            <h3 id="registerConfirmModalTitle">{{ registerConfirmTitle }}</h3>
          </div>
          <div class="form-dialog-body">
